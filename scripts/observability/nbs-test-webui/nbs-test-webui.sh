...
goto_advanced_search()
{
    ...
    TMP_BEARER_TOKEN=`grep nbs_token cookie-jar.txt | awk '{print $7}'`
...
exit 0
####################################################################################################
${CURL} "${TMP_URL}/icons/down-arrow-blue.svg" \
  --cookie cookie-jar.txt \
  --cookie-jar cookie-jar.txt \
  --show-error \
  -H 'authority: app.fts3.nbspreview.com' \
  ...
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: nbs_user=state; JSESSIONID=rsFY26RDq5NMwHtf0kFjsanypXSVP_P_ANA-Ti47; nbs_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnb3YuY2RjLm5icyIsImlhdCI6MTcwMjU4ODg5NiwiZXhwIjoxNzAyNTkwNjk2LCJzdWIiOiJzdGF0ZSJ9.Pw5d4AwVWXmLX_rNMpxvrCDHhwVXOj7jE1Q4fNsm2ig' \
  -H 'referer: https://app.fts3.nbspreview.com/advanced-search?q=NrtpfI68PmAX2uhPtGP%2BAEpoKI2l59mCV6DbgTPxeddvSC4yjszy3d9OHe0MuddOrJBxDjHveaMe0ZseHNeSC8ffCS7GuiOi&type=search' \
  -H 'sec-ch-ua: "Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'sec-ch-ua-platform: "Windows"' \
...
curl 'https://fonts.gstatic.com/s/publicsans/v15/ijwTs572Xtc6ZYQws9YVwnNDTJzaxw.woff2' \
  ...
  -H 'user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36' \
  -H 'x-client-data: CIm2yQEIprbJAQipncoBCNvsygEIkqHLAQjxmM0BCIWgzQEIou7NARin6s0BGLDvzQEY642lFw==' \
  --compressed
...
${CURL} "${TMP_URL}/nbs/login" \
  ...
  -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7' \
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cookie: JSESSIONID=Fa6eq4uS4pik8MY7BvqL3n2axK7E4t9uNmww_I33.ec2amaz-50h0je7; nbs_user=state; JSESSIONID=GWZZ50hSCSX49a1n1jRDq7bD9kSLxtGVG4TVplE_; nbs_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnb3YuY2RjLm5icyIsImlhdCI6MTcwMjU4NDIzNSwiZXhwIjoxNzAyNTg2MDM1LCJzdWIiOiJzdGF0ZSJ9.9rztou1WRzrhlJl1SzieRcfI5q44CHLJjTIQCztIHOU' \
  -H 'sec-ch-ua: "Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'sec-ch-ua-platform: "Windows"' \
  -H 'sec-fetch-dest: document' \
...
${CURL} "${TMP_URL}/nbs/nbslogin" \
  ...
  -H 'cache-control: max-age=0' \
  -H 'content-type: application/x-www-form-urlencoded' \
  -H 'cookie: JSESSIONID=FiQIQ24q5YeFrLPXdqQzNw50SMIf3rCMSsy6yddP.ec2amaz-50h0je7; nbs_user=state; JSESSIONID=GWZZ50hSCSX49a1n1jRDq7bD9kSLxtGVG4TVplE_; nbs_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnb3YuY2RjLm5icyIsImlhdCI6MTcwMjU4NDIzNSwiZXhwIjoxNzAyNTg2MDM1LCJzdWIiOiJzdGF0ZSJ9.9rztou1WRzrhlJl1SzieRcfI5q44CHLJjTIQCztIHOU' \
  -H 'origin: https://app.fts3.nbspreview.com' \
  -H 'referer: https://app.fts3.nbspreview.com/nbs/login' \
  -H 'sec-ch-ua: "Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"' \
  -H 'sec-ch-ua-mobile: ?0' \
...
${CURL} "${TMP_URL}/nbs/HomePage.do?method=loadHomePage" \
  ...
  -H 'accept-language: en-US,en;q=0.9' \
  -H 'cache-control: max-age=0' \
  -H 'cookie: JSESSIONID=g2RTxJrsisxp_Qh3hMTN8Ulf22RkHgMrFvN2apID.ec2amaz-50h0je7; nbs_user=state; JSESSIONID=GWZZ50hSCSX49a1n1jRDq7bD9kSLxtGVG4TVplE_; nbs_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnb3YuY2RjLm5icyIsImlhdCI6MTcwMjU4NDIzNSwiZXhwIjoxNzAyNTg2MDM1LCJzdWIiOiJzdGF0ZSJ9.9rztou1WRzrhlJl1SzieRcfI5q44CHLJjTIQCztIHOU' \
  -H 'referer: https://app.fts3.nbspreview.com/nbs/login' \
  -H 'sec-ch-ua: "Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"' \
  -H 'sec-ch-ua-mobile: ?0' \
  -H 'sec-ch-ua-platform: "Windows"' \
