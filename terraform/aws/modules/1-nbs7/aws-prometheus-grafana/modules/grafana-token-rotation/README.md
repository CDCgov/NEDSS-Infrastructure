...
This module deploys and configures resources to support Grafana token rotation for NBS7.
...
| <a name="input_rotation_schedule_days"></a> [rotation_schedule_days](#input_rotation_schedule_days) | Number of days between token rotations (must be less than token_expiration_days) | `number`      | `25`    |    no    |
