...
| kubernetes_version_control_plane | string    | `1.35`     | Desired Kubernetes version for control plane in EKS cluster                                                                                           |
| kubernetes_version_node_group | string       | `1.35`     | Kubernetes version for node group in EKS cluster                                                                                                      |
| addons                        | map of object(s) | See `./variables.tf` | Map of cluster addon configurations to enable for the cluster. Addon name can be the map keys or set with `name`.                       |
...
| ebs_volume_size               | number       | `100`      | EBS volume size backing _each_ EKS node on creation                                                                                                   |
