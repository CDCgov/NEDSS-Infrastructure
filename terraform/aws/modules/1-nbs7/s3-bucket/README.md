...
| <a name="input_delete_noncurrent_objects"></a> [delete_noncurrent_objects](#input_delete_noncurrent_objects)                                        | Number of days until the current object version is deleted and receives a delete marker, making the previous version noncurrent.               | `number`      | `60`         |    no    |
