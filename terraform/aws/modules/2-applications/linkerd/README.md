...
| <a name="input_eks_cluster_endpoint"></a> [eks_cluster_endpoint](#input_eks_cluster_endpoint)                                           | Name of the EKS cluster                                                  | `string` | n/a                                |   yes    |
...
| <a name="input_linkerd_helm_version"></a> [linkerd_helm_version](#input_linkerd_helm_version)                                           | linkerd edge helm version                                                | `string` | `"2025.7.3"`                       |    no    |
