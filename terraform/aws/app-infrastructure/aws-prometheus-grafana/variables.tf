...
variable "values_file_path" {
  ...
  default     = "../modules/aws-prometheus-grafana/modules/prometheus-helm/values.yaml" # "./.terraform/modules/prometheus/terraform/aws/app-infrastructure/aws-prometheus-grafana" # "../modules/aws-prometheus-grafana/modules/prometheus-helm/values.yaml"
}
