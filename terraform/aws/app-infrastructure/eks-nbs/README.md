...
| create_datacompare_irsa | bool | `false`           | Create an IRSA role for the datacompare service?                                                                                           |
...
| datacompare_s3_bucket_keyname_prefix            | string      | `null`    | KeyName (folder structure) for s3 bucket to be used for datacompare IRSA role.                                                                                      |
