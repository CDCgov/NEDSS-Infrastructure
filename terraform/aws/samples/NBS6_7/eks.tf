...
module "eks_nbs" {
  ...
  source = "git::https://github.com/CDCgov/NEDSS-Infrastructure.git//terraform/aws/app-infrastructure/eks-nbs?ref=v1.2.20"
  ...
  # mossc - do we need this? can the cross account role get kubernetes
  # access?  do we chang admin role name in inputs.tfvars?
  ...
  #deploy_istio_helm          = var.deploy_istio_helm
