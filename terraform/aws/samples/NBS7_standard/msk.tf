...
module "msk" {
  #source              = "git::https://github.com/CDCgov/NEDSS-Infrastructure.git//terraform/aws/app-infrastructure/msk?ref=v1.1.0-DEV"
  source              = "git::https://github.com/CDCgov/NEDSS-Infrastructure.git//terraform/aws/app-infrastructure/msk?ref=v1.1.4-DEV"
  ...
  #modern-cidr         = var.modern-cidr
  #vpn-cidr            = var.shared_vpc_cidr_block
