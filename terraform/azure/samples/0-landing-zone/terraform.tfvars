...
vnet_resource_group_name = "nbs7-<your_STLT_name>-<your_environment_name>" # The name of the existing Resource Group (in the Azure subscription specified by the next variable) that this Azure Terraform code will create resources in for this NBS 7 environment. This Resource Group must already be created (by some means other than this Terraform code).
...
subnet__endpoint__address_prefixes        = ["00.0.00.0/00"]
