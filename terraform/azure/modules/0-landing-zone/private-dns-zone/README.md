# Terraform Azure Module: 0-landing-zone/private-dns-zone

## Description

This module is used to deploy and configure Azure Private DNS Zones and related resources for NBS7.
...
| <a name="input_registration_enabled"></a> [registration_enabled](#input_registration_enabled)    | Whether auto registration is enabled                                                                                | `bool`                                                                                                                                                                                           | `false` |    no    |
