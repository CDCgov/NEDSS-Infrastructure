...
This module is used to deploy and configure Azure Virtual Networks (VNets) and related resources for NBS7.
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_vnet"></a> [vnet](#module\_vnet) | Azure/avm-res-network-virtualnetwork/azurerm | >=0.21.0, <1.0.0 |
...
| <a name="input_enabled"></a> [enabled](#input\_enabled) | Whether to create the vnet | `bool` | `true` | no |
