...
This module deploys and configures Azure Private DNS Zones for Storage Accounts and related resources for NBS7.
...
| <a name="input_virtual_network_name"></a> [virtual_network_name](#input_virtual_network_name) | List of virtual network names to be associated as a virtual network link for the private dns zone. | `list(string)` | `[]`    |    no    |

### Outputs

| Name                                                                                      | Description |
| ----------------------------------------------------------------------------------------- | ----------- |
| <a name="output_dns_zone_id_blob"></a> [dns_zone_id_blob](#output_dns_zone_id_blob)       | n/a         |
| <a name="output_dns_zone_id_file"></a> [dns_zone_id_file](#output_dns_zone_id_file)       | n/a         |
| <a name="output_dns_zone_name_blob"></a> [dns_zone_name_blob](#output_dns_zone_name_blob) | n/a         |
| <a name="output_dns_zone_name_file"></a> [dns_zone_name_file](#output_dns_zone_name_file) | n/a         |
